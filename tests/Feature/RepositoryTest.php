...
class RepositoryTest extends TestCase
{
    ...
    public function it_can_use_accessible_by_scope()
    {
        ...
        $this->assertSame($user->getMorphClass(), $bindings[2]);
        $this->assertSame($user->getKey(), $bindings[3]);
    }
